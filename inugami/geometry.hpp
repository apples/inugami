...
public:
    ...
    /*! @brief Create a Geometry from a cuboid.
     * 
     *  Creates a Geometry made of 8 vertices that form a cuboid with the given
     *  dimensions.
     * 
     *  @param w Width (X axis).
     *  @param h Height (Y axis).
     ...
     * 
     *  @return Geometry containing a cuboid.
     */
    static Geometry fromCuboid(float w, float h, float d);
